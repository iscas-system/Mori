...
int main(int argc, char** argv) {
    ...
    mori::status::Operator o1("o1"), o2("o2"), o3("o3"), o4("o4");
    o1.setPost("o2");
    o2.setPrev("o1");
    o2.setPost("o3");
    o3.setPrev("o1");
    ...
    frontend.registerTensor(mori::status::Tensor("t3", 512, mori::status::MemoryDataType::inout));
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        void* t3_ptr = allocate(mem_manager, session, 512);
